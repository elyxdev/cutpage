...
<body class="font-sans w-[100%]">
    <nav class="flex p-[20px] pt-[40px] w-[100%] h-[9vh] items-center text-white bg-black ">
      ...
      <section class="z-20 bg-grisva w-[80%] h-fit fixed top-[9%] left-[18%] rounded-xl p-6 items-center text-center hidden xl:hidden" id="items"> 
        <a href="#"><button class="rounded-full bg-prpl hover:bg-azulnav transtion duration-200 p-1 w-full mb-[25px]">Acortar</button></a>
        <a href="#"><button class="rounded-full bg-prpl hover:bg-azulnav transtion duration-200 p-1 w-full mb-[25px]">Mis acortadores</button></a>
        <a href="#"><button class="rounded-full bg-prpl hover:bg-azulnav transtion duration-200 p-1 w-full mb-[25px]">Perfil</button></a>
        <a href="#"><button class="rounded-full bg-prpl hover:bg-azulnav transtion duration-200 p-1 w-full mb-[5px]">Iniciar sesión</button></a>
